...
export default function ReduxCounter() {
    ...
    const addRecord = (event) => {
        ...
        if (!firstname || !lastname || !email || !grid || !subject || !priority || !salary || !experience || !job || !gender) {
            alert("Please fill out all fields before submitting.")
            return
        }

        if (editindex == null) {
            dispatch(addData({ id: Date.now(), firstname, lastname, email, grid, subject, priority, salary, experience, job, gender }))
        }
        else {
            dispatch(updateData({ id: editindex, firstname, lastname, email, grid, subject, priority, salary, experience, job, gender }))
            setEditIndex(null)
        }
        setFirstName("")
        setLastName("")
        ...
        <div className='body_main_div'>
            ...
            <div className="bg_flex">
                ...
                <div className="form_main">
                    <form action="">
                        <center>
                            <h1 className='form_head'>Login In</h1>
                        </center>
                        ...
                        <div className="main">
                            ...
                            <div className="check_box">
                                <h3></h3>
                                {/* <label> */}
                                    <input required className='check_input'
                                        type="checkbox"
                                        name="subscribe"
                                        checked={subscribe}
                                        ...
                                        return (
                                            <div className='data_flex_css'>
                                                ...
                                                <div className='data_div' key={i}>
                                                    ...
                                                    <h3><span style={{ color: 'rgb(255, 0, 106)' }}>Gender : </span> {e.gender}</h3>
